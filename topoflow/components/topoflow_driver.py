...
##            print ' '
            ...
            if (self.DONE):
                print 'Stopping: Reached Q_peak fraction.\n'
...
##            print ' '
            ...
            if (self.DONE):
                print 'Stopping: Reached stop time', self.T_stop, '\n'
            ...
            if (self.DONE):
                print 'Stopping: Reached number of steps.\n'
        else:
